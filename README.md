...
When running inside Shadow App, failed network-only quick actions can enter the native Keystore-encrypted queue
and are removed only after normal server execution succeeds.
