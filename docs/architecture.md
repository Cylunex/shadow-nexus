...
When a Proposal is sent to a domain Review endpoint, the Host forwards stable attachment references together with the Proposal source references. Domains can therefore retain evidence links without receiving or copying file bytes.
