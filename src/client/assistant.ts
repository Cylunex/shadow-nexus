...
import { buildNexusProcessingRules } from "../interaction-policy.js";
...
export async function submitNexus(
  ...
  const processingRules = buildNexusProcessingRules(domains);
...
export async function captureNexus(
  ...
  const processingRules = buildNexusProcessingRules(domains, "capture");
